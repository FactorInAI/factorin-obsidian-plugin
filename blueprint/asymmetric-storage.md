...
Due to the reasons above, with respect to the fact that most users don't care about remote shape when syncing (they can disable if they'd like to), **Anchored Asymmetric Storage™** is proposed to eliminate all the frictions.
